...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "test_fm", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("test_fm")
        ...
        # Variables
        ##################################################
        self.variable_qtgui_range_0 = variable_qtgui_range_0 = 104.4
        ...
        self._variable_qtgui_range_0_range = qtgui.Range(88.7, 110.1, 0.1, 104.4, 200)
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_c(
            ...
            (int(variable_qtgui_range_0 * 1000000)), #fc
            samp_rate, #bw
            "", #name
            1,
            None # parent
        ...
        self.iio_pluto_source_0.set_frequency((int(variable_qtgui_range_0 *1000000)))
    ...
    def set_variable_qtgui_range_0(self, variable_qtgui_range_0):
        ...
        self.iio_pluto_source_0.set_frequency((int(self.variable_qtgui_range_0 *1000000)))
        self.qtgui_freq_sink_x_0.set_frequency_range((int(self.variable_qtgui_range_0 * 1000000)), self.samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 100000, 50000, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range((int(self.variable_qtgui_range_0 * 1000000)), self.samp_rate)
